...
const CustomFooter = () => {
  ...
  return (
    <footer
      className="isolate bg-white mx-auto max-w-7xl p-5 md:p-0 border-t border-gray-900/10"
    ...
    >
      ...
      <div className="pt-10 lg:pt-20">
        <div className="grid md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 xl:gap-8 gap-3">
          <div
            onClick={() => navigate('/')}
            className="flex md:justify-center items-center lg:row-span-2 md:row-span-3 cursor-pointer"
          >
            <img
