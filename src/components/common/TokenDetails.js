  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <div className="flex flex-wrap gap-10 items-center">
        <div className="flex bg-gray-100 rounded-lg p-2 items-center gap-2">
          <svg
            fill="#000000"
            height="20px"
            viewBox="0 0 512 512"
        ...
        <div className="flex bg-gray-100 rounded-md p-2 items-center gap-2">
        ...
        <div className="flex bg-gray-100 rounded-md p-2 items-center gap-2">
          ...
          <p>Days until expiration : {tokenID}</p>
        </div>
      </div>
    </div>
  );
