    ...
    <div className="isolate bg-white mx-auto max-w-7xl px-5 text-gray-600">
      <div className="flex flex-col gap-1 items-center text-center ">
        ...
        <p className="text-sm leading-5 mt-5">
          As a verified human, not only could you build your on-chain reputation
          through a number of Community Soul Bound Tokens, you have access to
          on-chain voting on governance, participation in DAOs and grassroots
